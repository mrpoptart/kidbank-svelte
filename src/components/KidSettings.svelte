<script>
    import {
        ...
        ModalBody,
        ModalFooter,
        Label, Container, Row, Col, ListGroupItem, ListGroup
    } from "sveltestrap";
    import dayjs from "dayjs";
    import {set, remove} from "../firebase";
...
<Modal isOpen={open} {toggle}>
    ...
    <ModalBody>
        ...
        <ListGroup>
            ...
            <InputGroup>
                <ListGroupItem>{email.replace('%2E','.')}</ListGroupItem>
        ...
        <Form>
            <FormGroup>
                ...
                <InputGroup>
                    <Input bind:valid="{validEmail}" bind:invalid="{invalidEmail}" on:keypress={testEmail} type="email" bind:value={parentEmail}/>
                    <Button on:click={addParent}>Add Parent</Button>
                </InputGroup>
            </FormGroup>
        </Form>
        <Button color="danger">Delete {name}</Button>
    </ModalBody>
    <ModalFooter>
